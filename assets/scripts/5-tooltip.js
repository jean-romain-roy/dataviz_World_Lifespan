...
function getToolTipText(d, formatNumber) {
  ...
  return "Pays: <b>" + d.name 
          + "</b><br />Espérance de vie : <b>" + formatNumber(d.lifeExpectancy)
          +"</b> ans<br />Revenu : <b>"+formatNumber(d.income)
          +"</b> USD<br />Population : <b>"+formatNumber(d.population)
          +"</b> habitants<br />Zone du monde : <b>"+d.zone+"</b>";
}
